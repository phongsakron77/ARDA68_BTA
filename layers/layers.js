...
//ol.proj.get("EPSG:32647").setExtent([573845.174000, 2120379.861616, 596308.485700, 2131964.099300]);
var wms_layers = [];
...
var features_str_bta_4 = format_str_bta_4.readFeatures(json_str_bta_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32647'});
var jsonSource_str_bta_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_str_bta_4.addFeatures(features_str_bta_4);
var lyr_str_bta_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_str_bta_4, 
...
var features_lu_bta_5 = format_lu_bta_5.readFeatures(json_lu_bta_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32647'});
var jsonSource_lu_bta_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_lu_bta_5.addFeatures(features_lu_bta_5);
var lyr_lu_bta_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_lu_bta_5, 
...
var features_bdy_bta_6 = format_bdy_bta_6.readFeatures(json_bdy_bta_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32647'});
var jsonSource_bdy_bta_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_bdy_bta_6.addFeatures(features_bdy_bta_6);
var lyr_bdy_bta_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_bdy_bta_6, 
...
lyr_str_bta_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'HY_USE': 'HY_USE', 'HY_LNAME': 'HY_LNAME', 'HY_MRIVER': 'HY_MRIVER', 'LENGTH': 'LENGTH', 'TAM_NAM_T': 'TAM_NAM_T', });
lyr_lu_bta_5.set('fieldAliases', {'LU_ID_L1': 'LU_ID_L1', 'LU_ID_L2': 'LU_ID_L2', 'LU_ID_L3': 'LU_ID_L3', 'LU_CODE': 'LU_CODE', 'LU_DES_TH': 'LU_DES_TH', 'LU_DES_EN': 'LU_DES_EN', 'LUL1_CODE': 'LUL1_CODE', 'LUL2_CODE': 'LUL2_CODE', 'LU_DES': 'LU_DES', 'Shape_Area': 'Shape_Area', 'Area_Sqm': 'Area_Sqm', 'Area_Rai': 'Area_Rai', 'TAM_NAM_T': 'TAM_NAM_T', });
lyr_bdy_bta_6.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TAMBON_IDN': 'TAMBON_IDN', 'TAM_CODE': 'TAM_CODE', 'TAM_NAM_T': 'TAM_NAM_T', 'AMPHOE_IDN': 'AMPHOE_IDN', 'AMP_CODE': 'AMP_CODE', 'AMPHOE_T': 'AMPHOE_T', 'AMPHOE_E': 'AMPHOE_E', 'PROV_CODE': 'PROV_CODE', 'PROV_NAM_T': 'PROV_NAM_T', 'PROV_NAM_E': 'PROV_NAM_E', 'P_CODE': 'P_CODE', 'remark': 'remark', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_Flood_2.set('fieldImages', {'id': 'TextEdit', });
lyr_Drought_3.set('fieldImages', {'id': 'TextEdit', });
lyr_str_bta_4.set('fieldImages', {'OBJECTID': 'Range', 'HY_USE': 'Range', 'HY_LNAME': 'TextEdit', 'HY_MRIVER': 'TextEdit', 'LENGTH': 'TextEdit', 'TAM_NAM_T': 'TextEdit', });
lyr_lu_bta_5.set('fieldImages', {'LU_ID_L1': 'TextEdit', 'LU_ID_L2': 'TextEdit', 'LU_ID_L3': 'TextEdit', 'LU_CODE': 'TextEdit', 'LU_DES_TH': 'TextEdit', 'LU_DES_EN': 'TextEdit', 'LUL1_CODE': 'TextEdit', 'LUL2_CODE': 'TextEdit', 'LU_DES': 'TextEdit', 'Shape_Area': 'TextEdit', 'Area_Sqm': 'TextEdit', 'Area_Rai': 'TextEdit', 'TAM_NAM_T': 'TextEdit', });
lyr_bdy_bta_6.set('fieldImages', {'OBJECTID': 'TextEdit', 'TAMBON_IDN': 'TextEdit', 'TAM_CODE': 'TextEdit', 'TAM_NAM_T': 'TextEdit', 'AMPHOE_IDN': 'TextEdit', 'AMP_CODE': 'TextEdit', 'AMPHOE_T': 'TextEdit', 'AMPHOE_E': 'TextEdit', 'PROV_CODE': 'TextEdit', 'PROV_NAM_T': 'TextEdit', 'PROV_NAM_E': 'TextEdit', 'P_CODE': 'TextEdit', 'remark': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_Flood_2.set('fieldLabels', {'id': 'no label', });
lyr_Drought_3.set('fieldLabels', {'id': 'no label', });
lyr_str_bta_4.set('fieldLabels', {'OBJECTID': 'no label', 'HY_USE': 'no label', 'HY_LNAME': 'no label', 'HY_MRIVER': 'no label', 'LENGTH': 'no label', 'TAM_NAM_T': 'no label', });
lyr_lu_bta_5.set('fieldLabels', {'LU_ID_L1': 'no label', 'LU_ID_L2': 'no label', 'LU_ID_L3': 'no label', 'LU_CODE': 'no label', 'LU_DES_TH': 'no label', 'LU_DES_EN': 'no label', 'LUL1_CODE': 'no label', 'LUL2_CODE': 'no label', 'LU_DES': 'no label', 'Shape_Area': 'no label', 'Area_Sqm': 'no label', 'Area_Rai': 'no label', 'TAM_NAM_T': 'no label', });
lyr_bdy_bta_6.set('fieldLabels', {'OBJECTID': 'no label', 'TAMBON_IDN': 'no label', 'TAM_CODE': 'no label', 'TAM_NAM_T': 'no label', 'AMPHOE_IDN': 'no label', 'AMP_CODE': 'no label', 'AMPHOE_T': 'no label', 'AMPHOE_E': 'no label', 'PROV_CODE': 'no label', 'PROV_NAM_T': 'no label', 'PROV_NAM_E': 'no label', 'P_CODE': 'no label', 'remark': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_bdy_bta_6.on('precompose', function(evt) {
